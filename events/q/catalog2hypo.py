...
def createHypoellipseDefaultFile(defaultsDict, velocityDict, outFile):
...
import obspy
c = obspy.read_events("select.out")
velocityDict = readVelocityFile("STATION0.HYP")
stationsDict = readStationFile("STATION0.HYP")
catalog2hypoellipse(c, "hypoel.pha")
station2hypoellipse(stationsDict, "hypoel.sta")
velocity2hypoellipse(velocityDict, "hypoel.prm")
